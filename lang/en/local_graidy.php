...
$string['courseiframeview'] = 'View the GRAiDY course iframe';
$string['courseiframeview_desc'] = 'Allows users to view the iframe inside the GRAiDY course.';
...
$string['modiframeview'] = 'View the GRAiDY module iframe';
$string['modiframeview_desc'] = 'Allows users to view the iframe inside the GRAiDY module.';
